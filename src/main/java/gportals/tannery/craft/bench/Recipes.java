...
public class Recipes {
  ...
  static void addHelmetRecipe(Hide hide) {
    ...
    NamespacedKey key = new NamespacedKey(tannery, hide.getId() + "_helmet");
    ShapedRecipe recipe = new ShapedRecipe(key, result);
    recipe.shape("aaa", "axa", "xxx");
    recipe.setIngredient('a', hide.getFinalItem());
    recipe.setIngredient('x', Material.AIR);

    tannery.getLogger().info("Added helmet recipe for " + hide.getName());
  ...
  static void addChestplateRecipe(Hide hide) {
    ...
    NamespacedKey key = new NamespacedKey(tannery, hide.getId() + "_chestplate");
    ShapedRecipe recipe = new ShapedRecipe(key, result);
    recipe.shape("axa", "aaa", "aaa");
    recipe.setIngredient('a', hide.getFinalItem());
    recipe.setIngredient('x', Material.AIR);

    tannery.getLogger().info("Added chestplate recipe for " + hide.getName());
    Bukkit.addRecipe(recipe);
  }
  ...
  static void addLeggingsRecipe(Hide hide) {
    ...
    NamespacedKey key = new NamespacedKey(tannery, hide.getId() + "_leggings");
    ShapedRecipe recipe = new ShapedRecipe(key, result);
    recipe.shape("aaa", "axa", "axa");
    recipe.setIngredient('a', hide.getFinalItem());
    recipe.setIngredient('x', Material.AIR);

    tannery.getLogger().info("Added leggings recipe for " + hide.getName());
    Bukkit.addRecipe(recipe);
  }
  ...
  static void addBootsRecipe(Hide hide) {
    ...
    NamespacedKey key = new NamespacedKey(tannery, hide.getId() + "_boots");
    ShapedRecipe recipe = new ShapedRecipe(key, result);
    recipe.shape("axa", "axa", "xxx");
    recipe.setIngredient('a', hide.getFinalItem());
    recipe.setIngredient('x', Material.AIR);

    tannery.getLogger().info("Added boots recipe for " + hide.getName());
    Bukkit.addRecipe(recipe);
  }
}
